...
GOCRITIC := $(shell command -v gocritic || echo "bin/gocritic")
gocritic: bin/gocritic ## Installs gocritic (Audit)

bin/gocritic: bin
	@ printf "Install gocritic... "
	@ curl -Ls https://github.com/go-critic/go-critic/archive/refs/tags/v0.8.1.tar.gz -zOxf v0.8.1.tar.gz > $@ && chmod +x $@
	@ echo "done."
